...
extend_lexical_environment:
	...
	xor rcx, rcx                
.L_ext_env_copy_params:
	cmp rcx, r8
	je .L_ext_env_params_done
	mov r15, PARAM(rcx)
	mov qword [r14 + 8*rcx], r15
	inc rcx
	jmp .L_ext_env_copy_params
.L_ext_env_params_done:
        push r8
        push r9
        lea rdi , [r9*8 + 8]
	call malloc
...
.L_ext_env_copy_old:
	cmp rcx, r9
	je .L_ext_env_done
	mov rax, qword [r14 + 8*rcx]
	mov qword [r15 + 8*rcx + 8], rax
	inc rcx
	jmp .L_ext_env_copy_old
...
.L_apply_push:
        cmp rsi, sob_nil
        je .L_apply_push_done
        assert_pair(rsi)
        push SOB_PAIR_CAR(rsi)
        mov rsi, SOB_PAIR_CDR(rsi)
        jmp .L_apply_push
.L_apply_push_done:
        mov rcx, r8
